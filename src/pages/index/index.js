...
const uiInit = () => {
  ...
  if (process.env.AGORA_PROFILE === 'avc') {
    document.querySelector('#baseModeDropdown').innerHTML = `              
      <div class="dropdown-trigger">
        <a id="baseMode" data-value="avc" class="ag-rounded button" aria-haspopup="true" aria-controls="baseModeOptions">
          <span id="baseModeLabel">Osmotic Live</span>
      ...
      <div class="dropdown-menu" id="baseModeOptions" role="menu">
        <div class="dropdown-content">
          <div class="dropdown-item" data-value="avc" data-msg="Osmotic Live">
            <p>Osmotic Live</p>
            <hr>
    ...
    document.querySelector('#baseModeDropdown').innerHTML = `              
      ...
      <div class="dropdown-menu" id="baseModeOptions" role="menu">
        <div class="dropdown-content">
          <div class="dropdown-item" data-value="al" data-msg="Osmotic Live">
            <p>Osmotic Live</p>
            <hr>
